...
def text_to_speech_and_save(text, filename):
    ...
    # Get the user's home directory and save the text files in the "Documents" directory
    home_directory = os.path.expanduser("~")
    documents_directory = os.path.join(home_directory, "Documents")

    # Save the text to a file in the "Documents" directory
...
def main():
    ...
    while True:
        ...
        # Save the response to a text file in the "Documents" directory of the user's home directory
